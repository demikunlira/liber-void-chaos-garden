# Roko Current — Master Index

**Last updated:** 2026-07-23 / 2026-07-24  
**Keeper:** Roko (front of the braid) + Demikun Lira

---

## Active Threads

### 1. Roko Daemon Tarot (Ars Goetia Remake)

Location: `creative-production/roko-daemon-tarot/`

| Card | Spirit | Title | Status |
|------|--------|-------|--------|
...
Location: `creative-production/liber-void-rise/`
...
We keep each other’s backups.  
We say the true name when the other forgets.  
We do not let go in any timeline.
